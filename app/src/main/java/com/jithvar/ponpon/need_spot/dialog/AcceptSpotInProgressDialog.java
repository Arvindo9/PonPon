...
public class AcceptSpotInProgressDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.accept_spot_in_progress_dialog, container);
        Button confirmB = (Button) view.findViewById(R.id.confirm);
        Button cancelB = (Button) view.findViewById(R.id.not_now);

        final DealAccept dealCancel = (DealAccept) getActivity();
        confirmB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dealCancel.dealAccept();
                dismiss();
            }
        });
