...
public class ActiveAdapter extends BaseAdapter {
    ...
    private final ArrayList<ActiveData> list;

    public ActiveAdapter(FragmentActivity activity, ArrayList<ActiveData> inProgressList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.need_active_adapter, parent, false);
            ...
            holder.total_bet = (TextView) convertView.findViewById(R.id.total_bet_t);
            holder.highest_bet = (TextView) convertView.findViewById(R.id.highest_bet_tv);
            ...
            holder.amountStatus_tv = (TextView) convertView.findViewById(R.id.amount_status_tv);
            holder.confirmStatus_tv = (TextView) convertView.findViewById(R.id.confirm_status_tv);
        ...
        final ActiveData item = (ActiveData) this.getItem(position);
        assert item != null;
        ...
        holder.amountStatus_tv.setText(item.getStatusPayment());
        if(item.getStatusSpotByProvier().equals("Off")){
            holder.confirmStatus_tv.setText(activity.getResources().getString(R.string
                    .not_accept_yet));
        }

        holder.total_bet.setText(item.getTotalBet());
        holder.highest_bet.setText(item.getHighestBet());
    ...
    private class DataHolder{
        ...
        private TextView highest_bet;
        private TextView exitTimeP_tv;
        private TextView waitTimeP_tv;
        private TextView enterTimeS_tv;
        private TextView confirmStatus_tv;
        private TextView amountStatus_tv;
