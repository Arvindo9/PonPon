...
import com.jithvar.ponpon.need_spot.dialog.RejectSpotActiveDialog;
...
public class ActiveDetails extends FragmentActivity implements DealCancel {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.need_active_details);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.map_img:
                Intent i = new Intent(ActiveDetails.this, ViewLocationOnMap.class);
            ...
            case R.id.reject_seeker:
                DialogFragment newFragment2 = new RejectSpotActiveDialog();
    ...
    private class LoadDataFromServer extends AsyncTask<Void, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(ActiveDetails.this, AlertDialog
                    .THEME_HOLO_LIGHT);
                ...
                try {
                    ...
                    switch (jo.getString("Status")){
                        case "Success":
                            ...
                            break;
                        default:
                            Toast.makeText(ActiveDetails.this, getResources().getString(R.string
    ...
    private void showMassage(int id){
        Toast.makeText(ActiveDetails.this, getResources().getString(id), Toast.LENGTH_SHORT)
                .show();
    }
}
