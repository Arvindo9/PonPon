...
import com.jithvar.ponpon.need_spot.adapter.InProgressAdapter;
...
public class InProgress extends Fragment implements AbsListView.OnScrollListener, View.OnClickListener{

    private ProgressDialog mProgressDialog;
    private String userId;
    private String mobileNumber;
    private ArrayList<InProgressData> inProgressList;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.need_in_progress, container, false);

        inProgressList = new ArrayList<>();
        ListView listView = (ListView) rootView.findViewById(R.id.list_view);
        adapter = new InProgressAdapter(getActivity(), inProgressList);
        listView.setAdapter(adapter);
        listView.setOnScrollListener(this);
        loadNextList = false;

        ((FloatingActionButton) rootView.findViewById(R.id.add)).setOnClickListener(this);
...
//                    pageNO += 1;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.add:
                if(accountStatus) {
                    startActivity(new Intent(getActivity(), BookSpot.class));
                }
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                RequestBody formBody = new FormBody.Builder()
                        ...
                        .add("start_type", "NeedSpotInProgress")
                        .add("User_ID", userId)
                        .add("MobileNumber", mobileNumber)
                        .build();
                Request request = new Request.Builder()
                        .url(NEED_IN_PROGRESS)
                        .post(formBody)
                        .build();
            ...
            if(!result.equals("")) {
                try {
                    ...
                    switch (jo.getString("Status")){
                        case "Success":
                            pageNO = jo.getInt("CountId");      // page no
                            ...
                            for(int i = 0; i < array.length(); i++){
                                ...
                                inProgressList.add(new InProgressData(primaryIdSpotTb,
                                        ...
                                        enterTimeS, waitTimeS, betAmountS, highestBet, totalBet,
