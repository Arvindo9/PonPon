...
import com.jithvar.ponpon.need_spot.adapter.ExpireAdapter;
...
import static com.jithvar.ponpon.config.Config.NEED_EXPIRE;
...
public class Expire extends Fragment implements AbsListView.OnScrollListener{
    ...
    private ArrayList<ExpireData> activeList;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.need_expire, container, false);

        activeList = new ArrayList<>();
        ListView listView = (ListView) rootView.findViewById(R.id.list_view);
        adapter = new ExpireAdapter(getActivity(), activeList);
                    ...
                    switch (jo.getString("Status")){
                        case "Success":
                            ...
                            for(int i = 0; i < array.length(); i++){
                                ...
                                activeList.add(new ExpireData(primaryIdSpotTb,
