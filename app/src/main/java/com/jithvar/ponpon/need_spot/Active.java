...
public class Active extends Fragment implements AbsListView.OnScrollListener, View.OnClickListener{
    ...
    private ArrayList<ActiveData> activeList;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.need_active, container, false);

        activeList = new ArrayList<>();
        ListView listView = (ListView) rootView.findViewById(R.id.list_view);
        adapter = new ActiveAdapter(getActivity(), activeList);
                    ...
                    switch (jo.getString("Status")){
                        case "Success":
                            ...
                            for(int i = 0; i < array.length(); i++){
                                ...
                                activeList.add(new ActiveData(primaryIdSpotTb,
                                        ...
                                        statusSpotByProvier, statusSpotBySeeker, statusPayment));
                            }
