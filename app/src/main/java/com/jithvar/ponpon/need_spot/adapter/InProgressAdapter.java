...
import com.jithvar.ponpon.need_spot.InProgressDetails;
import com.jithvar.ponpon.need_spot.handler.InProgressData;
...
public class InProgressAdapter  extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.need_in_progress_adapter, parent, false);
            ...
            holder.mapLocationTrackingB = (Button) convertView.findViewById(R.id.map_track_button);
        ...
        holder.mapLocationTrackingB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(activity, FindLocationOnMap.class);
                i.putExtra("Latitude", item.getLatitude());
                i.putExtra("Longitude", item.getLongitude());
                i.putExtra("Address", item.getAddress());
                i.putExtra("AreaSize", item.getAreaSize());
    ...
    private class DataHolder{
        ...
        private Button mapLocationTrackingB;
