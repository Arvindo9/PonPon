package com.jithvar.ponpon.having_spot.adapter;
...
import com.jithvar.ponpon.having_spot.InProgressDetails;
...
public class InProgressAdapter extends BaseAdapter {
    ...
    private final ArrayList<InProgressData> list;

    public InProgressAdapter(FragmentActivity activity, ArrayList<InProgressData> inProgressList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.spot_in_progress_adapter, parent, false);
            ...
            holder.enterTimeP_tv = (TextView) convertView.findViewById(R.id.time_enter_p_tv);
        ...
        final InProgressData item = (InProgressData) this.getItem(position);
        assert item != null;
        ...
        holder.enterTimeP_tv.setText(item.getEnterTimeSpotTb());
        holder.exitTimeP_tv.setText(item.getExitTimeSpotTb());
        holder.waitTimeP_tv.setText(item.getExpireTimeSpotTb());
        holder.betAmountP_tv.setText(item.getBetAmountSpotTb());
        holder.betAmountS_tv.setText(item.getAddress());
        holder.enterTimeS_tv.setText(item.getEnterTimeBetTb());
        holder.waitTimeS_tv.setText(item.getWaitTimeBetTb());
...
//                i.putExtra("BetAmount", item.getBetAmount());
//                i.putExtra("ExpireTime", item.getWaitTime());
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(activity, InProgressDetails.class);
                i.putExtra("PrimaryIdSpotTb", item.getPrimary_id_spotTb());
                i.putExtra("PrimaryIdBetTb", item.getPrimary_id_betTb());
    ...
    private class DataHolder{
        ...
        private TextView enterTimeP_tv;
