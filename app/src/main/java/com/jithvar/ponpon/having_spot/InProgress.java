...
import com.jithvar.ponpon.having_spot.adapter.InProgressAdapter;
...
public class InProgress extends Fragment implements AbsListView.OnScrollListener, View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.in_progress, container, false);
                    ...
                    switch (jo.getString("Status")){
                        case "Success":
                            ...
                            for(int i = 0; i < array.length(); i++){
                                ...
                                inProgressList.add(new InProgressData(primary_ID_spotTb,
