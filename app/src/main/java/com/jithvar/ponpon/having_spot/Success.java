...
public class Success extends Fragment implements AbsListView.OnScrollListener{
    ...
    private ArrayList<SuccessData> inProgressList;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new SuccessAdapter(getActivity(), inProgressList);
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                RequestBody formBody = new FormBody.Builder()
                        ...
                        .add("start_type", "LoadSpotSuccess")
                        .add("User_ID", userId)
                        .add("MobileNumber", mobileNumber)
                        .build();
                Request request = new Request.Builder()
                        .url(HAVE_SPOT_SUCCESS)
                        .post(formBody)
                        .build();
                    ...
                    switch (jo.getString("Status")){
                        case "Success":
                            ...
                            for(int i = 0; i < array.length(); i++){
                                ...
                                inProgressList.add(new SuccessData(primary_ID_spotTb,
