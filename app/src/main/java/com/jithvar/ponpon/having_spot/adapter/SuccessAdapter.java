...
public class SuccessAdapter  extends BaseAdapter {
    ...
    private final ArrayList<SuccessData> list;

    public SuccessAdapter(FragmentActivity activity, ArrayList<SuccessData> inProgressList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.have_success_adapter, parent, false);
        ...
        final SuccessData item = (SuccessData) this.getItem(position);
        assert item != null;
